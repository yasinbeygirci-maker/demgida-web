        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm">
            ...
            <div className="bg-[#fcfaf7] p-6 rounded-2xl border border-neutral-200/60 space-y-2">
              ...
              <p className="text-xs text-neutral-700 font-medium">ERZİNCAN DEM GIDA İNŞAAT SANAYİ VE TİCARET LİMİTED ŞİRKETİ</p>
              <p className="text-xs text-neutral-600"><strong>Vergi Dairesi:</strong> Fevzipaşa</p>
              <p className="text-xs text-neutral-600"><strong>Vergi No:</strong> 3770988662</p>
            </div>
